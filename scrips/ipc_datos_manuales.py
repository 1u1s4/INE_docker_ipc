...
subcap_data_imputacion = ([
  ...
  ('May-2023', 1.22),
  ('Jun-2023', 0.78)],
 'El porcentaje de precios imputados en junio 2023 es de 0.78%. El mayor porcentaje de imputaciones fue en el mes de octubre 2022 con una cantidad de 5.28% y el menor se encuentra en el mes de junio 2023 con una cantidad de 0.78%.')
...
subcap_data = ([('Jun-2022', 6732),
  ...
  ('May-2023', 8344),
  ('Jun-2023', 9165)],
 'La cantidad de fuentes consultadas en junio 2023 es de 9,165. La mayor cantidad de fuentes consultadas fue en el mes de junio 2023 con una cantidad de 9,165 y la menor se encuentra en el mes de junio 2023 con una cantidad de 3,047.')
...
subcap_data = ([('Jun-2022', 34239),
  ...
  ('May-2023', 45964),
  ('Jun-2023', 48276)],
 'La cantidad de precios diligenciados en junio 2023 es de 48,276. La mayor cantidad de precios diligenciados fue en el mes de junio 2023 con una cantidad de 48,276 y la menor se encuentra en el mes de agosto 2022 con una cantidad de 32,350.')
reporte.agregar_subcapitulo(
